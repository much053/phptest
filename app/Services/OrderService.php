...
class OrderService extends Service
{
    ...
    public function detail($orderId)
    {
        ...
        $return = [
            ...
            'settleDiscount' => $order->partner_discount?:100,
            'settleFreeAmount' => bcmul($order->free_amount, ($order->partner_discount?:100)/100, 2),
            'settleTotalAmount' => bcmul($order->total_amount, ($order->partner_discount?:100)/100, 2),
